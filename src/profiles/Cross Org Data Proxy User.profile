...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <classAccesses>
        <apexClass>DealTriggerTest</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>FetchRelatedDeals</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>SalaryRaiseBatch</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>SoqlMethodsTest</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>UtilFactory</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <custom>false</custom>
    <fieldPermissions>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Sales_Manager__c.Birth_Date__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Sales_Manager__c.Is_Synced__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Sales_Manager__c.LastRaiseDate__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Sales_Manager__c.Salary__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <flowAccesses>
        <enabled>false</enabled>
        <flow>Date_edition_after_the_status_update</flow>
    </flowAccesses>
    <flowAccesses>
        <enabled>false</enabled>
        <flow>populate_Sales_Manager_Email</flow>
    </flowAccesses>
    <flowAccesses>
        <enabled>false</enabled>
        <flow>update_old_emails</flow>
    </flowAccesses>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Sales_Manager__c-Sales Manager Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
